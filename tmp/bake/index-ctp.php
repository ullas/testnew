<CakePHPBakeOpenTagphp echo $this->element('indexstyles') ; CakePHPBakeCloseTag>
...
<section class="content">
	<div class="row">
      ...
      <div class="col-md-8">
      	<CakePHPBakeOpenTagphp echo  $this->element('filters',$additional) CakePHPBakeCloseTag>
     </div> <!-- COL-7-->
  </div> <!--Row -->
...
<div class="modal fade" id="assign" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 <CakePHPBakeOpenTagphp echo $this->element('settings',[$configs,$usersettings]) CakePHPBakeCloseTag>
<CakePHPBakeOpenTagphp
    ...
    $('.mptl-daterange').daterangepicker(
     ...
     table= $('#mptlindextbl').DataTable({
        ...
        'render': function (data, type, full, meta){console.log(data);
     	...
     	'targets': [<CakePHPBakeOpenTagphp echo $usersettings['0']['value'] ;CakePHPBakeCloseTag>],
     	"visible": false,
     },
     ...
     $('<a href="/<CakePHPBakeOpenTagphp echo $this->request->params['controller'] CakePHPBakeCloseTag>/add/" class="btn btn-sm btn-success" style="margin-left:5px;" title="Add New Work Order"><i class="fa fa-plus" aria-hidden="true"></i></a>').appendTo('div.dataTables_filter');
 ...
 order= new $.fn.dataTable.ColReorder( table );
  ...
  // Handle click on "Select all" control
   ...
   $(".mptl-settings-save").click(function(){
	   ...
	   $.post("/<CakePHPBakeOpenTagphp echo $this->request->params['controller'] CakePHPBakeCloseTag>/updateSettings",
   		 {
       		 columns: hiddencols,
