...
use App\Model\Table\PdaccountsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PdaccountsTable Test Case
 */
class PdaccountsTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\PdaccountsTable     */
    public $Pdaccounts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pdaccounts') ? [] : ['className' => 'App\Model\Table\PdaccountsTable'];        $this->Pdaccounts = TableRegistry::get('Pdaccounts', $config);    }
