...
use App\Model\Table\InspectionformsInspectionitemsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InspectionformsInspectionitemsTable Test Case
 */
class InspectionformsInspectionitemsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InspectionformsInspectionitemsTable
     */
    public $InspectionformsInspectionitems;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('InspectionformsInspectionitems') ? [] : ['className' => 'App\Model\Table\InspectionformsInspectionitemsTable'];
        $this->InspectionformsInspectionitems = TableRegistry::get('InspectionformsInspectionitems', $config);
    }
    ...
    {
        unset($this->InspectionformsInspectionitems);
