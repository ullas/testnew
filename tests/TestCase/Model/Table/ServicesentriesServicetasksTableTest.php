...
use App\Model\Table\ServicesentriesServicetasksTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ServicesentriesServicetasksTable Test Case
 */
class ServicesentriesServicetasksTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ServicesentriesServicetasksTable
     */
    public $ServicesentriesServicetasks;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ServicesentriesServicetasks') ? [] : ['className' => 'App\Model\Table\ServicesentriesServicetasksTable'];
        $this->ServicesentriesServicetasks = TableRegistry::get('ServicesentriesServicetasks', $config);
    }
    ...
    {
        unset($this->ServicesentriesServicetasks);
