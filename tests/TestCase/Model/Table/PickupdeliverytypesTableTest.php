...
use App\Model\Table\PickupdeliverytypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PickupdeliverytypesTable Test Case
 */
class PickupdeliverytypesTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\PickupdeliverytypesTable     */
    public $Pickupdeliverytypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pickupdeliverytypes') ? [] : ['className' => 'App\Model\Table\PickupdeliverytypesTable'];        $this->Pickupdeliverytypes = TableRegistry::get('Pickupdeliverytypes', $config);    }
    ...
    {
        unset($this->Pickupdeliverytypes);
