...
use App\Model\Table\IssuesServicesentriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IssuesServicesentriesTable Test Case
 */
class IssuesServicesentriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IssuesServicesentriesTable
     */
    public $IssuesServicesentries;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IssuesServicesentries') ? [] : ['className' => 'App\Model\Table\IssuesServicesentriesTable'];
        $this->IssuesServicesentries = TableRegistry::get('IssuesServicesentries', $config);
    }
    ...
    {
        unset($this->IssuesServicesentries);
