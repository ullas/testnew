...
use App\Model\Table\PickupdeliverybranchesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PickupdeliverybranchesTable Test Case
 */
class PickupdeliverybranchesTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\PickupdeliverybranchesTable     */
    public $Pickupdeliverybranches;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pickupdeliverybranches') ? [] : ['className' => 'App\Model\Table\PickupdeliverybranchesTable'];        $this->Pickupdeliverybranches = TableRegistry::get('Pickupdeliverybranches', $config);    }
    ...
    {
        unset($this->Pickupdeliverybranches);
