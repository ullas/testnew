...
use App\Model\Table\DevicemodelsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DevicemodelsTable Test Case
 */
class DevicemodelsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DevicemodelsTable
     */
    public $Devicemodels;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Devicemodels') ? [] : ['className' => 'App\Model\Table\DevicemodelsTable'];
        $this->Devicemodels = TableRegistry::get('Devicemodels', $config);
    }
