...
use App\Model\Table\InspectionitemtypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InspectionitemtypesTable Test Case
 */
class InspectionitemtypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InspectionitemtypesTable
     */
    public $Inspectionitemtypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Inspectionitemtypes') ? [] : ['className' => 'App\Model\Table\InspectionitemtypesTable'];
        $this->Inspectionitemtypes = TableRegistry::get('Inspectionitemtypes', $config);
    }
    ...
    {
        unset($this->Inspectionitemtypes);
