...
use App\Model\Table\SimprovidersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SimprovidersTable Test Case
 */
class SimprovidersTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\SimprovidersTable     */
    public $Simproviders;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Simproviders') ? [] : ['className' => 'App\Model\Table\SimprovidersTable'];        $this->Simproviders = TableRegistry::get('Simproviders', $config);    }
