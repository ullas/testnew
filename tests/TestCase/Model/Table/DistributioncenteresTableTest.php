...
use App\Model\Table\DistributioncenteresTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DistributioncenteresTable Test Case
 */
class DistributioncenteresTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\DistributioncenteresTable     */
    public $Distributioncenteres;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Distributioncenteres') ? [] : ['className' => 'App\Model\Table\DistributioncenteresTable'];        $this->Distributioncenteres = TableRegistry::get('Distributioncenteres', $config);    }
    ...
    {
        unset($this->Distributioncenteres);
