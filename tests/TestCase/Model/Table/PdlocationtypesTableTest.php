...
use App\Model\Table\PdlocationtypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PdlocationtypesTable Test Case
 */
class PdlocationtypesTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\PdlocationtypesTable     */
    public $Pdlocationtypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pdlocationtypes') ? [] : ['className' => 'App\Model\Table\PdlocationtypesTable'];        $this->Pdlocationtypes = TableRegistry::get('Pdlocationtypes', $config);    }
