...
use App\Model\Table\DistributioncentersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DistributioncentersTable Test Case
 */
class DistributioncentersTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\DistributioncentersTable     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Distributioncenters') ? [] : ['className' => 'App\Model\Table\DistributioncentersTable'];        $this->Distributioncenters = TableRegistry::get('Distributioncenters', $config);    }
    ...
    {
        unset($this->Distributioncenters);
