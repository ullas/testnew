...
use App\Model\Table\DailysummaryTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DailysummaryTable Test Case
 */
class DailysummaryTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DailysummaryTable
     */
    public $Dailysummary;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Dailysummary') ? [] : ['className' => 'App\Model\Table\DailysummaryTable'];
        $this->Dailysummary = TableRegistry::get('Dailysummary', $config);
    }
