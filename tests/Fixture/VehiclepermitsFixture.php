...
/**
 * VehiclepermitsFixture
 *
 */
class VehiclepermitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'allowedstates' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'vehicle_id' => 1,
            'allowedstates' => 'Lorem ipsum dolor sit amet',
            'customer_id' => 1
        ],
    ];
}
