...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/Vehicleleases"> Vehicleleases</a></li>
      ...
      <div class="nav-tabs-custom">
        ...
        <?php
                  ...
                  echo $this->Form->input('maonthypayment');
                   ...
                   echo $this->Form->input('startdate', ['empty' => true,'type'=>'text', 'class'=>'datemask']);
                   
                   echo $this->Form->input('enddate', ['empty' => true,'type'=>'text', 'class'=>'datemask']);
