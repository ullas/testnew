...
<section class="content">
  ...
  <div class="box box-primary" style="min-height:134px">
      ...
      <div class="box-body" >
      	      <!--<a class="btn btn-app mptl mptl-assign">
      	      	<span class="badge bg-aqua">0</span>
                <i class="fa fa-edit"></i> Assign
              </a>
              <a class="btn btn-app mptl mptl-unassign">
              	<span class="badge bg-teal">0</span>
                <i class="fa fa-play"></i> Unassaign
              </a>
              <a class="btn btn-app mptl mptl-close">
              	<span class="badge bg-yellow">0</span>
                <i class="fa fa-repeat"></i> Close
              </a> -->
