...
<section class="content">
  ...
  <div class="col-md-12">
  	...
  	<div class="box box-primary">
        ...
        <tr>
            <th><?= __('Customer') ?></th>
            <td><?= $paymenttype->has('customer') ? $this->Html->link($paymenttype->customer->name, ['controller' => 'Customers', 'action' => 'view', $paymenttype->customer->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
    ...
    <div class="row">
        ...
        <?php if (!empty($paymenttype->deiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($paymenttype->deiveryorders as $deiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($paymenttype->pickupdeiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($paymenttype->pickupdeiveryorders as $pickupdeiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($paymenttype->pickuporders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($paymenttype->pickuporders as $pickuporders): ?>
            <tr>
