...
$(function () {
	...
	$.ajax({
         type : "POST",
            ...
            // alert(document.getElementById("asset-name").value);
            // $("#asset-name option[value='166']").prop("selected", true);
            // $("#asset-name").val("166");
	...
	$('#generatereport').click(function(){
		...
		if(document.getElementById("groupname").value != "" && document.getElementById("asset-name").value != "" && document.getElementById("month").value != "" )
		{
			$("#summarybox").hide();
