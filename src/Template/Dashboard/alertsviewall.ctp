  ...
  <div >
    <div class="content">
      ...
      <div class="modal-header" style="padding-bottom:0">
        <h3 class="modal-title" id="modalSettings">Alerts </h3>
      </div>
	            ...
	            <table id="timetable" class="table table-hover  table-bordered ">
	            	...
	            	<tbody>
	            		<?php
	            			...
	            			for ($i = 0; $i < count($alertcontent); $i++) {
	            				echo "<tr id=".$alertcontent[$i]['id'].">";
								echo "<td>".$alertcontent[$i]['alert']."</td>";
								echo "<td>".$alertcontent[$i]['alert_dtime']."</td>";
								echo "<td>".$alertcontent[$i]['ack']."</td>";
								echo "<td>".$alertcontent[$i]['location']."</td>";
								echo "<td>".$alertcontent[$i]['velocity']."</td>";
