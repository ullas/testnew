  ...
  <div >
    <div class="content">
      ...
      <div class="modal-header" style="padding-bottom:0">
        <h3 class="modal-title" id="modalSettings">Communication Failure</h3>
      </div>
	            ...
	            <table id="timetable" class="table table-hover  table-bordered ">
	            	...
	            	<tbody>
	            		<?php
	            			...
	            			for ($i = 0; $i < count($comfailurecontent); $i++) {
	            				echo "<tr id=".$comfailurecontent[$i]['id'].">";
								echo "<td>".$comfailurecontent[$i]['imei']."</td>";
								echo "<td>".$comfailurecontent[$i]['msgdtime']."</td>";
								echo "<td>".$comfailurecontent[$i]['status']."</td>";
								echo "<td>".$comfailurecontent[$i]['odometer']."</td>";
