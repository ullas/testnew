        ...
        <div class=" tab-content">
          <div class="active tab-pane" id="details">
             <div class="form-horizontal">
					...
					echo $this->Form->input('msrp', ['label'=>'MSRP','type'=>'text','empty' => true,'templateVars' => ['help' => 'Manufacturer suggested retail price','icon' => '<div class="input-group-addon"><i class="'.$mptlusercurrencyfaclass.'"></i></div>']]);
        	 		echo $this->Form->input('purpose_id', ['options' => $purposes, 'empty' => true,'class'=>'select2']);
             	    ?>
          ...
          <div class="tab-pane" id="fluids">
			...
			echo $this->Form->input('vehiclefluid.fueltank1_capacity', ['label'=>'Fuel Tank1 Capacity','type'=>'text','empty' => true,'templateVars' => ['help' => 'The volume of gas the vehicles primary gas tank can hold','icon' => '<div class="input-group-addon">' .$mptluservolumeunit.' </div>']]);
            echo $this->Form->input('vehiclefluid.fueltank2_capacity', ['label'=>'Fuel Tank2 Capacity','type'=>'text','empty' => true,'templateVars' => ['help' => 'The volume of gas the vehicles secondary gas tank can hold','icon' => '<div class="input-group-addon">' .$mptluservolumeunit.' </div>']]);
			echo $this->Form->input('vehiclefluid.oil_capacity', ['label'=>'Oil Capacity','type'=>'text','empty' => true,'templateVars' => ['help' => 'Capacity of oil reservoir','icon' => '<div class="input-group-addon">' .$mptluservolumeunit.' </div>']]);
        	?>
            </div>
          </div>
          <!-- /.tab-pane -->  
          ...
          <div class="tab-pane" id="lease">
           ...
           <?php	
            ...
            echo $this->Form->input('vehiclelease.amountfinanced', ['type'=>'text','empty' => true,'templateVars' => ['icon' => '<div class="input-group-addon"><i class="'.$mptlusercurrencyfaclass.'"></i></div>']]);
