...
<section class="content-header">
  <h1>
     Edit Schedule <small>Please fill the details to edit a Schedule</small>
  </h1>
  <ol class="breadcrumb">
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
         ...
         <?php
            ...
            echo $this->Form->input('end_time', ['empty' => true,'class'=>'timepicker']);echo $this->Form->input('timepolicy_id',['label'=>'Time Policy','class'=>'select2','empty' => true]);
            ...
            echo $this->Form->input('default_paxgrpid',['options' => $passengergroups,'label'=>'Default Passenger Group','empty' => true]);
        ?>
       </div>
