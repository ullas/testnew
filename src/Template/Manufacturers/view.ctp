...
<div class="manufacturers view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th><?= __('Customer') ?></th>
            <td><?= $manufacturer->has('customer') ? $this->Html->link($manufacturer->customer->name, ['controller' => 'Customers', 'action' => 'view', $manufacturer->customer->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
    ...
    <div class="related">
        ...
        <?php if (!empty($manufacturer->parts)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($manufacturer->parts as $parts): ?>
            <tr>
                <td><?= h($parts->id) ?></td>
