<section class="content-header">
  <h1>
     <?= h($pdlocationtype->name) ?> Details
  </h1>
  <ol class="breadcrumb">
  	<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
   
    <li><a href="/pdlocationtype/"> pdlocationtype</a></li>
...
<section class="content">
  ...
  <div class="col-md-12">
  	...
  	<div class="box box-primary">
        ...
        <tr>
            <th><?= __('Name') ?></th>
            <td><?= h($pdlocationtype->name) ?></td>
        </tr>
        <tr>
            <th><?= __('Customer') ?></th>
            <td><?= $pdlocationtype->has('customer') ? $this->Html->link($pdlocationtype->customer->name, ['controller' => 'Customers', 'action' => 'view', $pdlocationtype->customer->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
            <td><?= $this->Number->format($pdlocationtype->id) ?></td>
        </tr>
   </div><!--boxbody-->
   </div><!-- box -->
    ...
    <div class="row">
        ...
        <?php if (!empty($pdlocationtype->deiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pdlocationtype->deiveryorders as $deiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($pdlocationtype->pickupdeiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pdlocationtype->pickupdeiveryorders as $pickupdeiveryorders): ?>
            <tr>
