        ...
        <div class="tab-content" style="padding-top:45px">
         ...
         <?php
           ...
           // echo $this->Form->input('photo');
            ...
            echo $this->Form->input('reporingtime',['type' => 'text','empty' => true,'class' => 'timepicker','label'=>'Reporting Time','templateVars' => ['opentag' => '<div class="bootstrap-timepicker">','closetag' => '</div>','icon' => '<div class="input-group-addon"><i class="fa fa-clock-o"></i></div>']]);
