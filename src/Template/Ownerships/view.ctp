...
<div class="ownerships view large-9 medium-8 columns content">
    <h3><?= h($ownership->name) ?></h3>
    <table class="vertical-table">
        <tr>
            <th><?= __('Name') ?></th>
            <td><?= h($ownership->name) ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($ownership->customer_id) ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Vehicles') ?></h4>
        <?php if (!empty($ownership->vehicles)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($ownership->vehicles as $vehicles): ?>
            <tr>
                <td><?= h($vehicles->id) ?></td>
