...
<section class="content-header">
  <h1>
    Edit Trip <small>Please fill the details to edit the Trip</small>
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        ...
        <?php
            ...
            echo $this->Form->input('startpoint_id', ['label'=>'Start Point','type'=>'text','options' => $locations, 'empty' => true,'class'=>'select2']);
            echo $this->Form->input('endpoint_id', ['label'=>'End Point','type'=>'text','options' => $locations, 'empty' => true,'class'=>'select2']);
            ...
            echo $this->Form->input('last_location',['label'=>'Last Location','type'=>'text','options' => $locations, 'empty' => true,'class'=>'select2']);
			?>
			<div class="form-group">
			...
			echo $this->Form->input('aat', ['label'=>'AAT','class' => 'timepicker','type' => 'text','templateVars' => ['opentag' => '<div class="bootstrap-timepicker">','closetag' => '</div>','icon' => '<div class="input-group-addon"><i class="fa fa-clock-o"></i></div>']]);
			echo $this->Form->input('edt', ['label'=>'EDT','class' => 'timepicker','type' => 'text','templateVars' => ['opentag' => '<div class="bootstrap-timepicker">','closetag' => '</div>','icon' => '<div class="input-group-addon"><i class="fa fa-clock-o"></i></div>']]);
