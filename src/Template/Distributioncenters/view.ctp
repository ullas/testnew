<section class="content-header">
  <h1>
     <?= h($distributioncenter->name) ?> Details
  </h1>
  <ol class="breadcrumb">
  	<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
   
    <li><a href="/distributioncenter/"> distributioncenter</a></li>
...
<section class="content">
  ...
  <div class="col-md-12">
  	...
  	<div class="box box-primary">
        ...
        <tr>
            <th><?= __('Customer') ?></th>
            <td><?= $distributioncenter->has('customer') ? $this->Html->link($distributioncenter->customer->name, ['controller' => 'Customers', 'action' => 'view', $distributioncenter->customer->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
    ...
    <div class="row">
        ...
        <?php if (!empty($distributioncenter->deiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($distributioncenter->deiveryorders as $deiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($distributioncenter->pickupdeiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($distributioncenter->pickupdeiveryorders as $pickupdeiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($distributioncenter->pickuporders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($distributioncenter->pickuporders as $pickuporders): ?>
            <tr>
