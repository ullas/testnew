<section class="content-header">
  <h1>
     <?= h($pickupdeliverytype->name) ?> Details
  </h1>
  <ol class="breadcrumb">
  	<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
   
    <li><a href="/pickupdeliverytype/"> pickupdeliverytype</a></li>
...
<section class="content">
  ...
  <div class="col-md-12">
  	...
  	<div class="box box-primary">
        ...
        <tr>
            <th><?= __('Name') ?></th>
            <td><?= h($pickupdeliverytype->name) ?></td>
        </tr>
        <tr>
            <th><?= __('Customer') ?></th>
            <td><?= $pickupdeliverytype->has('customer') ? $this->Html->link($pickupdeliverytype->customer->name, ['controller' => 'Customers', 'action' => 'view', $pickupdeliverytype->customer->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
            <td><?= $this->Number->format($pickupdeliverytype->id) ?></td>
        </tr>
   </div><!--boxbody-->
   </div><!-- box -->
    ...
    <div class="row">
        ...
        <?php if (!empty($pickupdeliverytype->deiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pickupdeliverytype->deiveryorders as $deiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($pickupdeliverytype->pickupdeiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pickupdeliverytype->pickupdeiveryorders as $pickupdeiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($pickupdeliverytype->pickuporders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pickupdeliverytype->pickuporders as $pickuporders): ?>
            <tr>
