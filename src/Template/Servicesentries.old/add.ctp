...
<?php
  ...
  $myTemplates1 = [
    ...
    'input' => '<div class="col-sm-3" style="margin-left:5px"><input type="{{type}}" name="{{name}}"{{attrs}}/></div>',
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/Serviesentries/"> Service Entries</a></li>
    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        ...
        <?php
            ...
            echo $this->Form->input('odometer',['templateVars' => ['help' => 'Meter reading at the time of service']]); 
			...
			$this->Form->templates($myTemplates1);
