<section class="content-header">
  <h1>
     <?= h($pickupdeliverybranch->name) ?> Details
  </h1>
  <ol class="breadcrumb">
  	<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
   
    <li><a href="/pickupdeliverybranch/"> pickupdeliverybranch</a></li>
...
<section class="content">
  ...
  <div class="col-md-12">
  	...
  	<div class="box box-primary">
        ...
        <tr>
            <th><?= __('Name') ?></th>
            <td><?= h($pickupdeliverybranch->name) ?></td>
        </tr>
        <tr>
            <th><?= __('Customer') ?></th>
            <td><?= $pickupdeliverybranch->has('customer') ? $this->Html->link($pickupdeliverybranch->customer->name, ['controller' => 'Customers', 'action' => 'view', $pickupdeliverybranch->customer->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
            <td><?= $this->Number->format($pickupdeliverybranch->id) ?></td>
        </tr>
   </div><!--boxbody-->
   </div><!-- box -->
    ...
    <div class="row">
        ...
        <?php if (!empty($pickupdeliverybranch->deiveryorders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pickupdeliverybranch->deiveryorders as $deiveryorders): ?>
            <tr>
    ...
    <div class="row">
        ...
        <?php if (!empty($pickupdeliverybranch->pickuporders)): ?>
        </div>
  		<div class="box-body">
  		<table class="table table-hover">
            <tr>
            ...
            <?php foreach ($pickupdeliverybranch->pickuporders as $pickuporders): ?>
            <tr>
