<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Vehicletype'), ['action' => 'edit', $vehicletype->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Vehicletype'), ['action' => 'delete', $vehicletype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $vehicletype->id)]) ?> </li>
